...
/**
 ...
 @param serviceName The service for which to return the corresponding username.
 
 @param account The account for which to return the corresponding username.
 
 @return Returns a string containing the password for a given account and service, or `nil` if the Keychain doesn't
 have a password for the given parameters.
 
 @see usernameForService:account:error:
 */
+ (NSString *)usernameForService:(NSString *)serviceName account:(NSString *)account;
...
/**
 ...
 @return Returns a string containing the username for a given account and service, or `nil` if the Keychain doesn't
 have a username for the given parameters.
 
 @see usernameForService:account:
 */
+ (NSString *)usernameForService:(NSString *)serviceName account:(NSString *)account error:(NSError **)error;

/**
 Returns the username data for a given account and service, or `nil` if the Keychain doesn't have data
 ...
 @return Returns a the username data for the given account and service, or `nil` if the Keychain doesn't
 have data for the given parameters.
 
 @see usernameDataForService:account:error:
 */
+ (NSData *)usernameDataForService:(NSString *)serviceName account:(NSString *)account;
...
/**
 ...
 @see usernameDataForService:account:
 */
+ (NSData *)usernameDataForService:(NSString *)serviceName account:(NSString *)account error:(NSError **)error;
...
/**
 Deletes a Username from the Keychain.
 
 @param serviceName The service for which to delete the corresponding username.
 
 @param account The account for which to delete the corresponding username.
 
 @return Returns `YES` on success, or `NO` on failure.
 
 @see deleteUsernameForService:account:error:
 */
+ (BOOL)deleteUsernameForService:(NSString *)serviceName account:(NSString *)account;
...
/**
 ...
 @see deleteUsernameForService:account:
 */
+ (BOOL)deleteUsernameForService:(NSString *)serviceName account:(NSString *)account error:(NSError **)error;
...
/**
 Sets a Username in the Keychain.
 
 @param Username The password to store in the Keychain.
 
 @param serviceName The service for which to set the corresponding username.
 
 @param account The account for which to set the corresponding username.
 
 @return Returns `YES` on success, or `NO` on failure.
 
 @see setUsername:forService:account:error:
 */
+ (BOOL)setUsername:(NSString *)Username forService:(NSString *)serviceName account:(NSString *)account;
...
/**
 ...
 @see setUsername:forService:account:
 */
+ (BOOL)setUsername:(NSString *)Username forService:(NSString *)serviceName account:(NSString *)account error:(NSError **)error;

/**
 Sets arbirary data in the Keychain.
 
 @param Username The data to store in the Keychain.
 ...
 @see setUsernameData:forService:account:error:
 */
+ (BOOL)setUsernameData:(NSData *)Username forService:(NSString *)serviceName account:(NSString *)account;
...
/**
 ...
 @see setUsernameData:forService:account:
 */
+ (BOOL)setUsernameData:(NSData *)Username forService:(NSString *)serviceName account:(NSString *)account error:(NSError **)error;
